...
title Un-Nerf Compendium - Soul Dew (Ultra Sun / Ultra Moon)
echo ============================================================
echo   THE UN-NERF COMPENDIUM
echo   Soul Dew : restore Gen-6 +50pct Sp.Atk and Sp.Def (Latios/Latias)
...
%PY% "%~dp0unnerf.py" --cia "%CIA%" --mode souldew
echo.
pause
