...
public partial class PKMEditor
{
    private void PopulateFieldsPK3()
    {
        ...
        if (pk3 is PK3 p3a) // PKHaX: Gen-3 any-ability -- show the effective ability (override or slot) from the full list
        {
    ...
    private G3PKM PreparePK3()
    {
        ...
        if (pk3 is PK3 p3b) // PKHaX: Gen-3 any-ability -- write the slot bit if it matches a species slot, else the AbilityOverride byte (0x1E)
        {
